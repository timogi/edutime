-- Dev/staging DBs may still have legacy rows (days_30 / days_7 / renewal_day) from an older
-- run_org_renewal_reminder_sweep. Align with invoice due + 45 / + 90 only, one row per milestone per day.

truncate billing.org_renewal_reminders;
...
alter table billing.org_renewal_reminders
  ...
  check (reminder_type in ('invoice_overdue_45', 'invoice_overdue_90'));
