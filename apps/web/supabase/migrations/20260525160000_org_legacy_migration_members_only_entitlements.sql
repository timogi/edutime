-- Org legacy migration: org_seat only for active organization_members (not organization_administrators).
...
begin
  ...
  -- Admins do not receive org_seat automatically; only active organization_members.
  for v_member in
