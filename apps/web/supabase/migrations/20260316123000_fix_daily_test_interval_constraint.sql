-- Fix daily test personal renewals:
-- Keep 1-day periods for billing_cycle='daily_test' but store a
-- subscriptions.interval value accepted by subscriptions_interval_check.
