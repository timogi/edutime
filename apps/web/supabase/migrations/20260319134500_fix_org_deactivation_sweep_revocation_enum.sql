-- Fix enum assignment in org cancellation finalization sweep.
-- The revocation_reason column uses license.entitlement_revocation_reason.
-- Use valid enum values explicitly.
...
begin
  ...
  set status = 'expired',
      revocation_reason = 'subscription_canceled'::license.entitlement_revocation_reason,
