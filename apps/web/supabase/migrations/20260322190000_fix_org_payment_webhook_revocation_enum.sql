-- process_payrexx_org_payment compared revocation_reason to 'organization_deactivated',
-- which is not a value of license.entitlement_revocation_reason (sweep uses subscription_canceled).
-- That caused webhook processing to fail before checkout_sessions was marked completed.
...
begin
  ...
  -- Reactivate org_seat rows after sweep (subscription_canceled) or delinquency (payment_failed).
