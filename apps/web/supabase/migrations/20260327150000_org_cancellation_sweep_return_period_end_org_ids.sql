-- run_org_cancellation_finalization_sweep: also return organization ids finalized for
-- cancel-at-period-end (auto-renew off), so org-billing-jobs can notify admins by email.
...
begin
  -- Data-modifying CTE must be at the top level of this statement (not inside a subquery).
