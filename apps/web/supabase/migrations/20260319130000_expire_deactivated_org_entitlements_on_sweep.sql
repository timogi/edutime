-- Ensure deactivated organizations lose org-seat access on sweep.
-- This complements period-end cancellation finalization by also handling
-- organizations that were manually deactivated (public.organizations.is_active = false).
...
begin
  ...
  set status = 'expired',
      revocation_reason = case
        when coalesce(s.metadata ->> 'suspend_reason', '') = 'organization_deactivated'
          then 'organization_deactivated'
